      ...
      <div className="space-y-4">
              ...
              <Tabs value={activeSection} onValueChange={setActiveSection} className="w-full">
                  <div className="overflow-x-auto scrollbar-hide">
                      <TabsList className="flex w-max h-auto bg-transparent gap-2 p-0">
                          <TabsTrigger value="all" className="h-10 px-5 rounded-xl font-black data-[state=active]:bg-primary data-[state=active]:text-white border-2 border-muted">الكل</TabsTrigger>
                          {restaurant.menuSections.map((section) => (
                              <TabsTrigger key={section} value={section} className="h-10 px-5 rounded-xl font-black data-[state=active]:bg-primary data-[state=active]:text-white border-2 border-muted">{section}</TabsTrigger>
                          ))}
                      </TabsList>
                  </div>
              </Tabs>
       ...
       <div className="space-y-4">
        <div className="flex justify-between items-center px-1">
            <h2 className="text-xl font-black text-slate-800 dark:text-white flex items-center gap-2"><LayoutGrid className="h-5 w-5 text-primary"/> قائمة الوجبات</h2>
        </div>
