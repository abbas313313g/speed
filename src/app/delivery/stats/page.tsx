    ...
    <div className="p-6 space-y-6 bg-background pb-32 text-right">
      <header className="flex items-center gap-4 sticky top-0 bg-background/80 backdrop-blur-md z-10 py-2">
         ...
         <div className="text-right">
            ...
            <p className="text-[10px] text-muted-foreground font-bold">إدارة أرباحك وذمتك المالية</p>
         </div>
      </header>
       ...
       {isFrozen && (
          <div className="p-5 bg-destructive text-white rounded-[2rem] shadow-xl flex items-start gap-4 animate-in zoom-in">
              ...
              <div className="space-y-1">
                  ...
                  <p className="text-xs font-bold text-white/80">ذمتك النقدية للمكتب (ثمن الطلبات) تجاوزت الحد المسموح.</p>
              </div>
          </div>
       )}
      ...
      <div className="grid gap-3 grid-cols-1">
        ...
        <div className="grid grid-cols-2 gap-3">
            <Card className="rounded-[1.5rem] border-none shadow-md bg-white border-r-4 border-r-destructive">
                <CardHeader className="p-4 pb-1"><CardTitle className="text-[10px] font-bold text-muted-foreground flex items-center gap-2 justify-end"><Banknote className="h-3 w-3 text-destructive"/> ذمة للمكتب (كاش)</CardTitle></CardHeader>
