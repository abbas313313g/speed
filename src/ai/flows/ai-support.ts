...
- **معلومات سائق التوصيل (جديد!):** بعد أن يقبل سائق التوصيل الطلب، ستظهر معلوماته (اسمه ورقم هاتفه) في تفاصيل الطلب بصفحة "الطلبات"، ليتمكن المستخدم من التواصل معه إذا لزم الأمر.
- **حالات الطلب هي:**
...
**6. معلومات داخلية (لا تشاركها إلا عند الضرورة القصوى):**
- عند إجراء أي طلب جديد، يتم إرسال تفاصيل الطلب كاملة مع موقع الزبون إلى بوت تليجرام خاص بالإدارة لمتابعة الطلبات وتنسيقها.
- يتم تعيين الطلبات الجديدة للسائقين بشكل تلقائي وذكي بناءً على السائق الأقل استلاماً للطلبات لضمان التوزيع العادل.
